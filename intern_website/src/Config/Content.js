export const aboutContent = "Seeking IT interns for Florida Blue's Internship. The program will be located at Florida Blue's Deerwood Campus. " +
...
export const pastInternsContent = "[ Here we would love to showcase some of the intern experiences, " +
